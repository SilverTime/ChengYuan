/**
 * Created by mooshroom on 2016/1/21.
 */
define('uploader', [
    'avalon',
    'jquery',
    'text!../../lib/uploader/uploader.html',
    'css!../../lib/uploader/uploader.css',
    '../../lib/uploader/webuploader.js'
], function (avalon, $, html, css) {
    avalon.component('tsy:uploader', {
        $template: html,
        id: "",
        show: false,
        //上传工具设置
        boxID: 'uploader',//最外面的div的ID
        dnd: "dndArea",
        filePicker: "filePicker",
        label: "点击选择图片",//上传按钮的名字
        filePicker2: "filePicker2",
        tip: "或者将文件拖到这里,最多支持300个文件",
        $conf: {
            pick: {
                id: '',
                label: ''
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: apiURL + 'File/File/upload&tsy=' + cache.go("tsy"),
